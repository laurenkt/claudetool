...
- It contrasts old behaviour with new behaviour. Github PR comments should explain why X was replaced with Y, code comments explain why we do Y, with no reference to X.
